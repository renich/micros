...
The Sovereign Commandments of Code Quality
===========================================

Every line of code committed to MicrOS must comply with the Sovereign Commandments defined in `AGENTS.md <AGENTS.md>`_:
...
8. **Zero-Alloc Hot Paths**: All dynamic memory allocations must take an explicit ``std.mem.Allocator`` parameter. Hidden global state allocations are forbidden, and hot driver, ISR, and IPC paths must be strictly zero-allocation.
...
To understand how the MicrOS codebase is structured, its dual-target execution model, boot entry points, subsystem interactions, and developer navigation workflows, consult the comprehensive codebase guides:

* **English**: `Understanding the MicrOS Codebase <docs/technical/code-guide.rst>`_
* **Español**: `Guía para Comprender la Base de Código de MicrOS <docs/technical/code-guide-es.rst>`_
